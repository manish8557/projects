...
//ALGORTIHM USED IN THIS CODE IS MULTI LEVEL FEEDBACK QUEUE SCHEDULING ALGORITHM
//CONSTRAINS OF THIS CODE IS THAT IT IS NOT WORKING FOR THE PROCESSES HAVING ARRIVAL TIME GREATER THAN 0
